...
namespace TwitterClient.Demo
{
    public class TwitterClient
    {
        ...
        public virtual void LoadData()
        {
            ...
            // get the correct number of ms for unixTimeStamp
            var date = (Int64)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalMilliseconds;
            string uuid1 = "556716f7-2e54-4715-9f00-91dcbea6cf50";
            Session.Execute("INSERT INTO posts (post_id, username, post_date, body) " +
                  "VALUES (" +
                      uuid1 + "," +
                      "'Phil'," +
                      date + "," +
            ...
            string uuid6 = "956716f7-2e54-4715-9f00-91dcbea6cf50";
            Session.Execute("INSERT INTO posts (post_id, username, post_date, body) " +
                  "VALUES (" +
                      uuid6 + "," +
                      "'Jimmy'," +
                      date + "," +
                      "'Xamarin is free...Xamarin is free!!!!!!1 #build2016'" +
                      ");");
            Session.Execute("INSERT INTO userposts (username, post_id, body) " +
                  "VALUES (" +
                      "'Jimmy'," +
